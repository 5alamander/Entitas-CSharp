...
namespace Entitas {
    ...
    public static class EntitasCache {
        ...
        public static List<GroupChangedHandler<TEntity>> GetGroupChangedList<TEntity>() where TEntity : class, IEntity, new()
            { return _cache.Get<List<GroupChangedHandler<TEntity>>>(); }

        public static void PushGroupChangedList<TEntity>(List<GroupChangedHandler<TEntity>> list) where TEntity : class, IEntity, new()
